 ...
 * <p>
 * An instance of this class is assigned to the document main.model so that
 ...
 * {@link main.com.lynden.gmapsfx.javascript.object.GoogleMap} class to register an
 * instance of the {@link GFXEventHandler} interface against a certain event 
 * type in the Google Maps event main.model. See addUIEventHandler and addStateEventHandler.
 * <p>
 * This class uses a key based on a UUID to map the Javascript event handlers 
 * registered against the Google Maps main.model back to our Java event handlers
 ...
 * <p>
 * {@link main.com.lynden.gmapsfx.javascript.object.GoogleMap#addUIEventHandler}
 ...
 * </code></pre></blockquote>
 * <p>
 * {@link main.com.lynden.gmapsfx.javascript.object.GoogleMap#addStateEventHandler}
 * <p><blockquote><pre><code>
