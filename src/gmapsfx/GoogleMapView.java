...
public class GoogleMapView extends AnchorPane {
    ...
    /**
     * Creates a new map main.view and specifies if the FireBug pane should be
    ...
    /**
     * Creates a new map main.view and specifies the display language and API key.
     *
    ...
    public GoogleMapView(String mapResourcePath, String language, String region, String key, boolean debug) {
        ...
        if (mapResourcePath == null) {
            if (debug) {
                htmlFile = "/resources/html/maps-debug.html";
            } else {
